...
export default function OfferHotelClient({ propertySlug }) {
  ...
  `https://clarkscms.cinuniverse.com/Api/property/GetPropertyByFilter?PropertyId=${id}`
);
...
setBannerImages(bannerImgs);
        ...
        const offerRes = await fetch(
          `https://clarkscms.cinuniverse.com/Api/offers/GetOffersByProperty?propertyId=${id}`
        );
