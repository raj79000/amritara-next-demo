  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://clarkscms.cinuniverse.com/Api/Venue/GetVenueByProperty?propertyId=${propertyIdFetched}`
        );
        ...
        const bannerRes = await fetch(
          `https://clarkscms.cinuniverse.com/Api/property/GetPropertyByFilter?PropertyId=${propertyIdFetched}`
        );
